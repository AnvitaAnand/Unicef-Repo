...
top_countries = grouped.groupby('country')['obs_value'].sum().sort_values(ascending=False).head(20).index
...
fig = px.sunburst(
    ...
    title='Sunburst Chart: Top 20 Countries → Year → Deaths (Age 5–14)',
